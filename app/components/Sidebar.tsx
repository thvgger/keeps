...
export default function Sidebar({ 
  ...
  return (
    <div className={containerClasses}>
            ...
            {colNotes.map((note, noteIndex) => {
              ...
              return (
                <ContextMenu key={note.id}>
                  ...
                  <ContextMenuContent className="bg-neutral-900/95 backdrop-blur-md border border-white/10 text-white min-w-40 rounded-xl p-1.5 shadow-2xl animate-in fade-in-0 zoom-in-95 duration-100">
                    <ContextMenuItem 
                      onClick={() => onNoteSelect?.(note.id)}
      ...
      <button onClick={() => onNoteSelect?.("new")} className="fixed bottom-8 right-10 md:right-12 w-16 h-16 rounded-full flex items-center justify-center shadow-lg shadow-indigo-500/30 hover:scale-105 transition-transform z-50 bg-white text-black">
